  ...
  const renderHeader = () => {
    return (
      <section className="default-padding grid select-none grid-cols-[1fr_auto] items-center gap-x-4 bg-emerald-300/20 py-2 sm:py-4">
        <div className="text-lg/normal sm:text-2xl/normal text-amber-100">You scored <span className={`badge-large inline-flex w-7 h-7 justify-center ${score ? 'badge-emerald' : 'badge-red'}`}>{score}</span></div>
